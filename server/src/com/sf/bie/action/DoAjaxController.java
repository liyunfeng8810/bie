...
public class DoAjaxController extends BaseController{
	 ...
	 */
	@ResponseBody
	@RequestMapping(params="method=getCityInfo",method=RequestMethod.POST)
	public String getCityInfo(String params) throws Exception{		
		return userService.getCityInfo().getCityInfo();
